...
class DoudizhuGame:
    ...
    def m_init_game(self):
        ...
        self.round.rn = self.rn
        self.round.m_initiate(self.players)
    ...
    def get_state(self, player_id):
        ...
        rule_actions = list(self.judger.playable_cards[player_id])
        state['rule_actions'] = rule_actions
